    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child_cat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parents', to='catalog.category', verbose_name='Дочерняя категория')),
                ('parent_cat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='catalog.category', verbose_name='Родительская категория')),
            ],
            options={
